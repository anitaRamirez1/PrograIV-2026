                    ...
                    <table class="table table-striped table-hover" id="tblDocentes">
                        ...
                        <tbody>
                            <tr v-for="docente in docentes" :key="docente.idDocente" @click="modificarDocente(docente)" style="cursor: pointer;">
                                ...
                                <td>
                                    <button class="btn btn-danger btn-sm" @click="eliminarDocente(docente, $event)">ELIMINAR</button>
                                </td>
                            </tr>
                            <tr v-if="docentes.length === 0">
                                <td colspan="8" class="text-center">No hay docentes que coincidan con la búsqueda</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
